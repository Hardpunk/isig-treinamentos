                    ...
                    <div class="pt-4">
                        <div class="subscribe-form">
                            <form action="" method="post" class="d-md-flex">
                                <input type="email" required="" name="inputletter" id="inputletter" class="form-control" placeholder="Digite seu email">
                                <input type="hidden" name="newsletter">
                                <button class="botaoFooter">Cadastrar</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="col-md-12 social-media text-aling-center">
                ...
                <a href="http://instagram.com/isig.treinamentos">  <i class="fab fa-instagram"></i></a>
        ...
        <div class="col-md-2">
            <a target="_blank" href="https://transparencyreport.google.com/safe-browsing/search?url=https:%2F%2Fisigtreinamentos.com.br%2F&hl=pt_BR"> <img class="selo-footer my-3" src="/images/site-seguro.png"> </a>
        </div>

    </div>
</div>

<p class="copyright m-0">Copyright 2021 Isig Treinamentos®</p>
</div>
